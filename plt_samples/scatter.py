...
plt.xlabel('Real wind speed (m/s)') 
plt.ylabel('Simulated wind speed (m/s)')
plt.axis([0,35,0,35]) 
fig.set_size_inches(6.5,6.5) 
ax1.plot([0,35],[0,35],'k-',linewidth=1)
ax1.scatter(obw_test, fcw_test,c='r',marker='o',label='Origional',s=10,linewidths=1)
ax1.scatter(obw_test, prw_test,c='c',marker='s',label='Optimized',s=10,linewidths=1)
plt.legend(loc='upper left',frameon=True)
plt.savefig('./Bpscatter.png',bbox_inches='tight')
