...
def create_model(init_mode='uniform'):
    model = Sequential() 
    model.add(Dense(64,input_dim=nf,kernel_initializer=init_mode))
    model.add(Activation('relu'))
    model.add(Dense(32,input_dim=64,kernel_initializer=init_mode))
    model.add(Activation('relu'))
    model.add(Dense(16,input_dim=32,kernel_initializer=init_mode))
    model.add(Activation('relu'))
    model.add(Dense(1,input_dim=16,kernel_initializer=init_mode)) 
